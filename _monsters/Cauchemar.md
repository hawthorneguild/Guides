...
> **Languages** Quori, telepathy 60 ft.  
> **CR** 5 (XP 1,800; PB +3)
>
> ### Traits
>
> ***Amorphous.*** The cauchemar can move through a space as narrow as 1 inch wide without squeezing.
>
> ***Incorporeal Movement.*** The cauchemar can move through other creatures and objects as if they were difficult terrain. It takes 5 (1d10) force damage if it ends its turn inside an object.
>
> ***Innate Spellcasting.*** The cauchemar's innate spellcasting ability is Charisma (spell save DC 16). It can innately cast the following spells, requiring no material components:
> 
> At will: *color spray*, *mind sliver*, *sleep* > 3/day each: *hallucinatory terrain*, *phantasmal force* > 1/day each: *dream*, *major image* (as a 6th-level spell)
>
> ***Pernicious Feeding.*** If a fey or humanoid within 30 feet of the cauchemar fails an Intelligence, Wisdom, or Charisma saving throw, the target takes 8 (1d6 + 5) psychic damage. The cauchemar regains a number of hit points equal to the psychic damage taken. If the cauchemar already has all its hit points when it deals damage with this trait, it instead gains temporary hit points equal to half the psychic damage taken.
>
> ### Actions
>
> ***Multiattack.*** The cauchemar attacks three times with its disorient. It can replace one of these attacks by casting a spell it is capable of innately casting at will.
>
> ***Disorient.*** *Ranged Spell Attack:* +8 to hit, range 30 ft., one creature. *Hit:* 8 (1d6 + 5) psychic damage, and the target has disadvantage on Intelligence, Wisdom, and Charisma saving throws until the end of the cauchemar's next turn. Furthermore, until the end of the cauchemar's next turn, the target is treated as if it has half as many hit points for the purpose of enchantment and illusion spells (such as *color spray* and *sleep*) that can target only a certain number of hit points' worth of creatures.
